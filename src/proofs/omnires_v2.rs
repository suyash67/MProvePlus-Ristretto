...
mod omniring_tests {
    ...
    #[test]
    pub fn test_omniresv2_aok_1_in_8(){
        ...
        let mprove_test = Omniresv2::prove(&G, 
                                            &H, 
                                            &H_prime, 
                                            &p_vec, 
                                            &g_prime_vec, 
    ...
    pub fn test_omniresv2_helper(n: usize, s: usize){
    ...
    #[test]
    fn omniresv2_2_in_100(){
        test_omniresv2_helper(100, 2);
    }
    
    #[test]
    fn omniresv2_5_in_100(){
        test_omniresv2_helper(100, 5);
    }

    #[test]
    fn omniresv2_4_in_500(){
        test_omniresv2_helper(500, 4);
    }

    #[test]
    fn omniresv2_19_in_20(){
        test_omniresv2_helper(20, 19);
    }
