...
pub trait TranscriptProtocol {
    ...
    /// Append a domain separator for an s-out-of-n mprove proof.
    fn mproveproof_domain_sep(&mut self, n: u64, s: u64);
...
impl TranscriptProtocol for Transcript {
    ...
    fn mproveproof_domain_sep(&mut self, n: u64, s: u64) {
        self.append_message(b"dom-sep", b"mproveproof v1");
        self.append_u64(b"n", n);
        self.append_u64(b"s", s);
    }
